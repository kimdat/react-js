...
const NavProfile = (props) => {
    ...
    <div className={styles.profileBody}>
      <div className={styles.profileNameBar}>
        <div className={styles.title}>
          <h4 className={styles.titleText}>{profileGreeting(email)}</h4>
        </div>
  ...
  return (
    <Popover.Root>
      <Popover.Trigger asChild>{profileToggleButton}</Popover.Trigger>
      <Popover.Portal>
        <Popover.Content
          sideOffset={0}
          align="end"
        ...
        >
          ...
          <Popover.PopoverClose asChild>{closeBtn}</Popover.PopoverClose>
          {profileContent}
        </Popover.Content>
      </Popover.Portal>
    </Popover.Root>
