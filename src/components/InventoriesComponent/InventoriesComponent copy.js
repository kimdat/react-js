  ...
  ({
    ...
    const toggleRowDetails = useCallback(
      async (row) => {
        ...
        const showChild =
          rowData.showChild === "0" ||
          rowData.showChild === "false" ||
          rowData.showChild === false;
        newSearchApiData[rowIndex].showChild = showChild;
      ...
      [searchApiData, getChildren, setSearchApiData]
    );
              ...
              <div>
                <div style={{ display: "flex", alignItems: "center" }}>
                  <Button variant="link" onClick={() => toggleRowDetails(row)}>
                    {row.showChild === "true" || row.showChild === true ? (
